...
/**
 * Multiblocked capability for Blood Magic LP (Life Points) system.
 */
public class LPMultiblockCapability extends MultiblockCapability<Integer> {
    ...
    public static final LPMultiblockCapability CAP = new LPMultiblockCapability();

    private LPMultiblockCapability() {
        super("bloodmagic_lp", 0xFFCC0000, SERIALIZER);
    }
    ...
    protected CapabilityProxy<? extends Integer> createProxy(@Nonnull IO io, @Nonnull BlockEntity blockEntity) {
        return new LPCapabilityProxy(blockEntity);
    }

    @Override
    public ContentWidget<Integer> createContentWidget() { return new LPContentWidget(); }

    @Override
    public boolean hasTrait() { return true; }

    @Override
    public CapabilityTrait createTrait() { return new LPCapabilityTrait(); }
