...
public class LPContentWidget extends ContentWidget<Integer> {

    private static final int COLOR = 0xFFCC0000;

    @Override
    protected void onContentUpdate() {
        if (content != null) {
            setHoverTooltips(String.format("%d LP", content));
        }
    }
    ...
    protected void drawHookBackground(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        font.drawShadow(poseStack, "LP", (pos.x + 1) * 2f, (pos.y + 1) * 2f, COLOR);
        if (content != null) {
    ...
    public void openConfigurator(WidgetGroup group) {
        ...
        group.addWidget(new LabelWidget(5, 50, "LP Amount"));
